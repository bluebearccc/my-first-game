...
This project is indexed by GitNexus as **my-first-game** (902 symbols, 2148 relationships, 73 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
