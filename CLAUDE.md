...
This project is indexed by GitNexus as **my-first-game** (7328 symbols, 17149 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
